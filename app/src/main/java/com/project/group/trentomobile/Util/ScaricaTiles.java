...
public class ScaricaTiles extends AsyncTask<Preferenze,Void,TileMemoryRep> {
    ...
    protected TileMemoryRep doInBackground(Preferenze... params) {
        ...
        try {
            ...
            myPreference = (Preferenze) InternalStorage.readObject(myActivity, "myPreferenze3");
            ...
            try {
                InternalStorage.writeObject(myActivity,"myPreferenze3",myPreference);
